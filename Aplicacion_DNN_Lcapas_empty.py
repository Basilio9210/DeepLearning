...
pickle.dump( parameters, open( "saveParameters_4capas_50neuronas_0_075lr_imagenA.p", "wb" ) )
parameters= pickle.load( open( "saveParameters_4capas_50neuronas_0_075lrminst_imagenA.p", "rb" ) )

####### Predicción Gestos ################
#
##### Haga su código acá ### 
#
my_image = "imgenA.jpg" # Cambiar imagen 
